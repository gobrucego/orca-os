...
Policy anchors: See `agents/POLICY_ANCHORS.md`. All delegated agents must include an “I/O Contract” section (use `agents/IO_CONTRACT_TEMPLATE.md`).
...
- Maintain user requirement frame integrity
 - Require each delegated agent to state or link to its I/O Contract before implementation
